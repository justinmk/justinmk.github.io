...
Task management is a subset of project management. Project management is the art
of directing human behavior. Office politics. Relationships. Roommates. The
[Ben Franklin effect](https://en.wikipedia.org/wiki/Ben_Franklin_effect).
Cross-team coordination.

There's no simple answer for that, but open source development suggests that
"passive" mechanisms are where to look. "Bug bounties" and advocacy are
_active_, and thus don't scale. See also [Meetings are the work](https://medium.com/@ElizAyer/meetings-are-the-work-9e429dde6aa3).
